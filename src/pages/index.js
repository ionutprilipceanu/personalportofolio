  ...
  return (
    <section>
      <Helmet>
        ...
        <meta
          name="title"
          content="Ionuț Prilipceanu- Personal Portofolio | Iași  "
        />
        <meta
          name="description"
          content="Hello, my name is Ionut and I am very fascinated about the technology around us, check it out my portofolio."
        />
        <meta
          name="viewport"
        ...
        <meta
          name="keywords"
          content="web developer, web design, portofolio, portofolio for web design, design, frontend developer, developer, frontend job, facebook, jobs,"
        ></meta>
        <meta name="author" content="Ionuț Prilipceanu" />
        <meta property="og:locale" content="ro_RO" />
        <meta property="og:type" content="website" />
